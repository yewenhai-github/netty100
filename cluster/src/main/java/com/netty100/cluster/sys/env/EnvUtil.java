...
import com.netty100.cluster.sys.utils.DiskUtils;
...
import com.netty100.cluster.plugin.environment.CustomEnvironmentPluginManager;
...
public class EnvUtil {
     ...
     * The key of cap home.
     */
    public static final String NACOS_HOME_KEY = "cap.home";
    ...
    public static final String SERVER_PORT_PROPERTY = "com.netty100.kernel.tcp.port";
    
    public static final int DEFAULT_SERVER_PORT = 8981;

    public static final String SERVER_CLUSTER_PROPERTY = "com.netty100.kernel.cluster";

    public static final String DEFAULT_WEB_CONTEXT_PATH = "";
    
    public static final String MEMBER_LIST_PROPERTY = "cap.member.list";
    
    public static final String NACOS_HOME_PROPERTY = "user.home";
    
    public static final String CUSTOM_CONFIG_LOCATION_PROPERTY = "spring.config.additional-location";
    
    public static final String DEFAULT_CONFIG_LOCATION = "application.properties";
    
    public static final String DEFAULT_RESOURCE_PATH = "/application.properties";
    
    public static final String DEFAULT_ADDITIONAL_PATH = "conf";
    
    public static final String DEFAULT_ADDITIONAL_FILE = "cluster.conf";
    
    public static final String NACOS_HOME_ADDITIONAL_FILEPATH = "kernel";

    private static String confPath = "";

    public static final String NACOS_TEMP_DIR_1 = "data";
    
    public static final String NACOS_TEMP_DIR_2 = "tmp";

    public static final String NACOS_CUSTOM_ENVIRONMENT_ENABLED = "cap.custom.environment.enabled";

    public static final String NACOS_CUSTOM_CONFIG_NAME = "customFirstNacosConfig";
     ...
     *
     * <p>
     * If there are setting of {@code cap.core.sys.basic.processors} in config/JVM/system, use it. If no setting, use
    ...
    public static String getCluster() {
        clusterName = getProperty(SERVER_CLUSTER_PROPERTY, String.class, "");
        return clusterName;
    }
     ...
     */
    public static List<String> analyzeAddressServerClusterConf(RemotingHttpResult result) throws IOException {
        List<String> instanceList = new ArrayList<String>();
        JSONObject jsonObject = JSONObject.parseObject(result.getResponseStr());
        JSONArray datas = (JSONArray)jsonObject.get("data");
        if(SysUtility.isNotEmpty(datas)){
            for (int i = 0; i < datas.size(); i++) {
                JSONObject data = (JSONObject)datas.get(i);
                String serverStatus = data.getString("serverStatus");
                if(!"1".equals(serverStatus)){
                    continue;
                }

                String url = data.getString("intranetIp")+":"+data.getString("port");
    ...
    public static List<String> readClusterConf() throws IOException {
        try (Reader reader = new InputStreamReader(new FileInputStream(new File(getClusterConfFilePath())),
            ...
            return analyzeFileClusterConf(reader);
    ...
    public static List<String> analyzeFileClusterConf(Reader reader) throws IOException {
        List<String> instanceList = new ArrayList<String>();
        ...
        for (String line : lines) {
            ...
            if (multiIndex > 0) {
                ...
                //support the format: 192.168.71.52:8981
