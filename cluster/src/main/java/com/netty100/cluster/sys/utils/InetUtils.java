...
import com.netty100.cluster.common.notify.SlowEvent;
...
import static com.netty100.cluster.sys.env.Constants.IP_ADDRESS;
import static com.netty100.cluster.sys.env.Constants.NACOS_SERVER_IP;
import static com.netty100.cluster.sys.env.Constants.PREFER_HOSTNAME_OVER_IP;
import static com.netty100.cluster.sys.env.Constants.SYSTEM_PREFER_HOSTNAME_OVER_IP;
import static com.netty100.cluster.sys.env.Constants.USE_ONLY_SITE_INTERFACES;
...
public class InetUtils {
     ...
     * System property cap.server.ip
     * Spring property cap.inetutils.ip-address.
     *
     * @return ip address
     */
    public static String getNacosIp() {
        ...
        if (!StringUtils.isBlank(nacosIp)) {
            if (!(InternetAddressUtil.isIP(nacosIp) || InternetAddressUtil.isDomain(nacosIp))) {
                throw new RuntimeException("cap address " + nacosIp + " is not ip");
            }
        }
    ...
    /**
     * {@link ServerMemberManager} is listener.
     */
