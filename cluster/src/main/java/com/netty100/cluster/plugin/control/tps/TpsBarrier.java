...
import com.netty100.cluster.plugin.control.tps.cap.LocalSimpleCountBarrierCreator;
...
public abstract class TpsBarrier {
    ...
    static {
        ...
        Collection<RuleBarrierCreator> loadedCreators = CapServiceLoader.load(RuleBarrierCreator.class);
