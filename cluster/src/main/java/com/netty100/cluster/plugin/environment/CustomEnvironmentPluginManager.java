...
package com.netty100.cluster.plugin.environment;

import com.netty100.cluster.plugin.environment.spi.CustomEnvironmentPluginService;
...
public class CustomEnvironmentPluginManager {
    ...
    private void loadInitial() {
        Collection<CustomEnvironmentPluginService> customEnvironmentPluginServices = CapServiceLoader.load(
