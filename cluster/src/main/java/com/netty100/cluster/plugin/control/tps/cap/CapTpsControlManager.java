...
import com.netty100.cluster.plugin.control.tps.TpsBarrierCreatorProxy;
import com.netty100.cluster.plugin.control.tps.TpsControlManager;
import com.netty100.cluster.plugin.control.tps.TpsMetrics;
...
import com.netty100.cluster.plugin.control.tps.response.TpsResultCode;
...
public class CapTpsControlManager extends TpsControlManager {
    ...
    public CapTpsControlManager() {
        executorService = ExecutorFactory.newSingleScheduledExecutorService(r -> {
            Thread thread = new Thread(r, "cap.plugin.tps.control.reporter");
