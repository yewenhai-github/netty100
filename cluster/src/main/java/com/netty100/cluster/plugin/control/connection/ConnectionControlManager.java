...
package com.netty100.cluster.plugin.control.connection;
...
public abstract class ConnectionControlManager {
    ...
    public ConnectionControlManager() {
        metricsCollectorList = CapServiceLoader.load(ConnectionMetricsCollector.class);
    ...
    private void initExecuteService() {
        executorService = ExecutorFactory.newSingleScheduledExecutorService(r -> {
            Thread thread = new Thread(r, "cap.plugin.control.connection.reporter");
