...
package com.netty100.cluster.consistency.serialize;
...
public class HessianSerializer implements Serializer {
    ...
    private SerializerFactory serializerFactory = new CapHessianSerializerFactory();
    ...
    public <T> T deserialize(byte[] data, Class<T> cls) {
        ...
        throw new CapDeserializationException(cls, new ClassCastException(
