...
package com.netty100.cluster.naming.model.form;
...
public class InstanceMetadataBatchOperationForm implements Serializable {
     ...
     * check param.
     *
     * @throws CapApiException NacosApiException
     */
    public void validate() throws CapApiException {
        fillDefaultValue();
        if (StringUtils.isBlank(serviceName)) {
            throw new CapApiException(HttpStatus.BAD_REQUEST.value(), ErrorCode.PARAMETER_MISSING,
