...
import com.netty100.cluster.common.trace.event.naming.PushServiceTraceEvent;
...
import com.netty100.cluster.naming.push.v2.PushConfig;
import com.netty100.cluster.naming.push.v2.PushDataWrapper;
import com.netty100.cluster.naming.push.v2.hook.PushResult;
import com.netty100.cluster.naming.push.v2.hook.PushResultHookHolder;
...
public class PushExecuteTask extends AbstractExecuteTask {
    ...
    private class ServicePushCallback implements NamingPushCallback {
         ...
         * implement of {@link PushExecutor}.
         */
