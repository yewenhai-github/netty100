...
import com.netty100.cluster.naming.remote.udp.AckEntry;
import com.netty100.cluster.naming.remote.udp.UdpConnector;
...
public class UdpPushService {
    ...
    public void pushDataWithoutCallback(Subscriber subscriber, ServiceInfo serviceInfo) {
        ...
        try {
            ...
            Loggers.PUSH.error("[CAP-PUSH] failed to push serviceName: {} to client, error: {}", serviceName, e);
        }
    }
    ...
    private static AckEntry prepareAckEntry(InetSocketAddress socketAddress, Map<String, Object> data,
        ...
        if (MapUtils.isEmpty(data)) {
            Loggers.PUSH.error("[CAP-PUSH] pushing empty data for client is not allowed: {}", socketAddress);
            return null;
        }
        ...
        try {
            ...
            Loggers.PUSH
                    .error("[CAP-PUSH] failed to compress data: {} to client: {}, error: {}", data, socketAddress, e);
            return null;
        }
    }
    ...
    private static AckEntry prepareAckEntry(InetSocketAddress socketAddress, byte[] dataBytes, Map<String, Object> data,
        ...
        try {
            ...
            Loggers.PUSH
                    .error("[CAP-PUSH] failed to prepare data: {} to client: {}, error: {}", data, socketAddress, e);
        }
        return null;
    }
