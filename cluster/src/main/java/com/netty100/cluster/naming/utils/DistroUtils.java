...
import com.netty100.cluster.common.utils.MD5Utils;
...
import static com.netty100.cluster.naming.misc.UtilsAndCommons.DEFAULT_CLUSTER_NAME;
...
public class DistroUtils {
    ...
    public static String checksum(Client client) {
        ...
        return MD5Utils.md5Hex(s, com.netty100.cluster.api.common.Constants.ENCODE);
    }
    ...
    private static boolean getEnabled(InstancePublishInfo ip) {
        Object enabled0 = ip.getExtendDatum().get(Constants.PUBLISH_INSTANCE_ENABLE);
    ...
    private static double getWeight(InstancePublishInfo ip) {
        Object weight0 = ip.getExtendDatum().get(Constants.PUBLISH_INSTANCE_WEIGHT);
        if (!(weight0 instanceof Number)) {
            return Constants.DEFAULT_INSTANCE_WEIGHT;
        } else {
