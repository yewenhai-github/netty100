...
package com.netty100.cluster.naming.core.v2.service.impl;
...
import com.netty100.cluster.common.utils.ClassUtils;
...
import com.netty100.cluster.consistency.snapshot.LocalFileMeta;
import com.netty100.cluster.consistency.snapshot.Reader;
import com.netty100.cluster.consistency.snapshot.SnapshotOperation;
import com.netty100.cluster.consistency.snapshot.Writer;
import com.netty100.cluster.core.distributed.ProtocolManager;
import com.netty100.cluster.core.utils.Loggers;
import com.netty100.cluster.naming.consistency.persistent.impl.AbstractSnapshotOperation;
...
import com.netty100.cluster.naming.core.v2.client.manager.impl.PersistentIpPortClientManager;
...
public class PersistentClientOperationServiceImpl extends RequestProcessor4CP implements ClientOperationService {
    ...
    public void registerInstance(Service service, Instance instance, String clientId) {
        ...
        if (singleton.isEphemeral()) {
            throw new CapRuntimeException(CapException.INVALID_PARAM,
    ...
    public void batchRegisterInstance(Service service, List<Instance> instances, String clientId) {
        //TODO PersistentClientOperationServiceImpl Cap batchRegister
    }
