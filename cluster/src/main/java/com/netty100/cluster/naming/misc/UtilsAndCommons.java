...
public class UtilsAndCommons {
    ...
    public static final String NACOS_SERVER_CONTEXT = "/cap";
    ...
    public static final String RAFT_CACHE_FILE_PREFIX = "com.netty100.cluster.naming";
...
//        JacksonUtils.registerSubtype(LabelSelector.class, SelectorType.label.name());
     ...
     */
    public static Map<String, String> parseMetadata(String metadata) throws Exception {
        ...
        try {
            ...
            if (datas.length > 0) {
                for (String data : datas) {
                    ...
                    if (kv.length != 2) {
                        throw new Exception("metadata format incorrect:" + metadata);
                    }
