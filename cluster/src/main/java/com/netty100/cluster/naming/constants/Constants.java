...
package com.netty100.cluster.naming.constants;
...
public final class Constants {
    ...
    public static final String NAMING_PERSISTENT_SERVICE_GROUP = "naming_persistent_service_v1";
    
    public static final String NAMING_PERSISTENT_SERVICE_GROUP_V2 = "naming_persistent_service_v2";
    
    public static final String NACOS_NAMING_USE_NEW_RAFT_FIRST = "cap.naming.use-new-raft.first";
    
    /**
     * Time interval to clear empty services, unit: millisecond. default: 60000 ms.
     */
    public static final String EMPTY_SERVICE_CLEAN_INTERVAL = "cap.naming.clean.empty-service.interval";
    
    /**
     * Expiration time of empty service, unit: millisecond. default: 60000 ms.
     */
    public static final String EMPTY_SERVICE_EXPIRED_TIME = "cap.naming.clean.empty-service.expired-time";
    
    /**
     * Time interval to clear expired metadata, unit: millisecond. default: 5000 ms.
     */
    public static final String EXPIRED_METADATA_CLEAN_INTERVAL = "cap.naming.clean.expired-metadata.interval";
    
    /**
     * Expiration time of expired metadata, unit: millisecond. default: 60000 ms.
     */
    public static final String EXPIRED_METADATA_EXPIRED_TIME = "cap.naming.clean.expired-metadata.expired-time";
    
    /**
     * default: false.
     */
    public static final String DATA_WARMUP = "cap.naming.data.warmup";
    
    /**
     * default : true.
     */
    public static final String EXPIRE_INSTANCE = "cap.naming.expireInstance";
