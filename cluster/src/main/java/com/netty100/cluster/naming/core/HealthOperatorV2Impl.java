...
import com.netty100.cluster.api.naming.pojo.healthcheck.HealthCheckType;
...
import com.netty100.cluster.naming.utils.InstanceUtil;
...
public class HealthOperatorV2Impl implements HealthOperator {
    ...
    public void updateHealthStatusForPersistentInstance(String namespace, String fullServiceName, String clusterName,
            String ip, int port, boolean healthy) throws CapException {
    ...
    private void throwHealthCheckerException(String fullServiceName, String clusterName) throws CapException {
        String errorInfo = String
                .format("health check is still working, service: %s, cluster: %s", fullServiceName, clusterName);
        throw new CapException(CapException.INVALID_PARAM, errorInfo);
    }
}
