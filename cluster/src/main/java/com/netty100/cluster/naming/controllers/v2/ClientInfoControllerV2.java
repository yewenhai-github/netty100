...
public class ClientInfoControllerV2 {
     ...
     */
    @GetMapping()
    public Result<ObjectNode> getClientDetail(@RequestParam("clientId") String clientId) throws CapApiException {
    ...
    private void checkClientId(String clientId) throws CapApiException {
        if (!clientManager.contains(clientId)) {
            throw new CapApiException(HttpStatus.NOT_FOUND.value(), ErrorCode.RESOURCE_NOT_FOUND,
