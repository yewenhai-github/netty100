...
package com.netty100.cluster.naming.selector;
...
import com.netty100.cluster.api.selector.context.SelectorContextBuilder;
...
public class SelectorManager {
    ...
    private void initSelectorContextBuilders() {
        Collection<SelectorContextBuilder> selectorContextBuilders = CapServiceLoader.load(SelectorContextBuilder.class);
    ...
    private void initSelectorTypes() {
        Collection<Selector> selectors = CapServiceLoader.load(Selector.class);
     ...
     */
    public Selector parseSelector(String type, String condition) throws CapException {
        ...
        try {
            ...
            throw new CapException(CapException.SERVER_ERROR, "Selector parses failed: " + e.getMessage());
        }
    }
