...
package com.netty100.cluster.naming.healthcheck;

import com.netty100.cluster.naming.healthcheck.heartbeat.BeatCheckTask;
import com.netty100.cluster.naming.healthcheck.interceptor.HealthCheckTaskInterceptWrapper;
...
public class HealthCheckReactor {
    ...
    public static void scheduleCheck(BeatCheckTask task) {
        Runnable wrapperTask =
                task instanceof CapHealthCheckTask ? new HealthCheckTaskInterceptWrapper((CapHealthCheckTask) task)
                        : task;
