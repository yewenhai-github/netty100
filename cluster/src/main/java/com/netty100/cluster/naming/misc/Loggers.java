...
public class Loggers {
    ...
    public static final Logger PUSH = LoggerFactory.getLogger("com.netty100.cluster");
    
    public static final Logger CHECK_RT = LoggerFactory.getLogger("com.netty100.cluster");
    
    public static final Logger SRV_LOG = LoggerFactory.getLogger("com.netty100.cluster");
    
    public static final Logger EVT_LOG = LoggerFactory.getLogger("com.netty100.cluster");
    
    public static final Logger RAFT = LoggerFactory.getLogger("com.netty100.cluster");
    
    public static final Logger DISTRO = LoggerFactory.getLogger("com.netty100.cluster");
    
    public static final Logger PERFORMANCE_LOG = LoggerFactory.getLogger("com.netty100.cluster");
