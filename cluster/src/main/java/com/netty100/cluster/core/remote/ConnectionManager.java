...
import com.netty100.cluster.plugin.control.ControlManagerCenter;
...
public class ConnectionManager {
    ...
    public void initConnectionEjector() {
        ...
        try {
            ...
            Collection<RuntimeConnectionEjector> ejectors = CapServiceLoader.load(RuntimeConnectionEjector.class);
        ...
        if (runtimeConnectionEjector == null) {
            ...
            CapRuntimeConnectionEjector capRuntimeConnectionEjector = new CapRuntimeConnectionEjector();
            capRuntimeConnectionEjector.setConnectionManager(this);
            runtimeConnectionEjector = capRuntimeConnectionEjector;
        }
    }
