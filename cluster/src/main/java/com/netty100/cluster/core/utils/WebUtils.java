...
import com.netty100.cluster.common.model.RestResultUtils;
...
public class WebUtils {
    ...
    public static String getAcceptEncoding(HttpServletRequest req) {
        String encode = StringUtils.defaultIfEmpty(req.getHeader(HttpHeaderConsts.ACCEPT_ENCODING), StandardCharsets.UTF_8.name());
