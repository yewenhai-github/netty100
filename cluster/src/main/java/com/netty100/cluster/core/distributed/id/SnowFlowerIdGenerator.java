...
package com.netty100.cluster.core.distributed.id;

import com.netty100.cluster.consistency.IdGenerator;
...
public class SnowFlowerIdGenerator implements IdGenerator {
    ...
    {
        long workerId = EnvUtil.getProperty("cap.core.snowflake.worker-id", Integer.class, -1);
