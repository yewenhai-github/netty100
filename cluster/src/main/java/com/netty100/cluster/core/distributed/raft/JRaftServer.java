...
package com.netty100.cluster.core.distributed.raft;

//import com.netty100.cluster.common.JustForTest;
import com.netty100.cluster.core.distributed.raft.exception.DuplicateRaftGroupException;
import com.netty100.cluster.core.distributed.raft.exception.JRaftException;
import com.netty100.cluster.core.distributed.raft.exception.NoLeaderException;
import com.netty100.cluster.core.distributed.raft.exception.NoSuchRaftGroupException;
...
import com.netty100.cluster.common.utils.LoggerUtils;
import com.netty100.cluster.common.utils.StringUtils;
import com.netty100.cluster.common.utils.ThreadUtils;
import com.netty100.cluster.consistency.ProtoMessageUtil;
...
import com.netty100.cluster.consistency.exception.ConsistencyException;
import com.netty100.cluster.core.distributed.raft.utils.FailoverClosure;
import com.netty100.cluster.core.distributed.raft.utils.FailoverClosureImpl;
import com.netty100.cluster.core.distributed.raft.utils.JRaftConstants;
import com.netty100.cluster.core.distributed.raft.utils.JRaftUtils;
import com.netty100.cluster.core.distributed.raft.utils.RaftExecutor;
import com.netty100.cluster.core.distributed.raft.utils.RaftOptionsBuilder;
//import com.netty100.cluster.core.monitor.MetricsMonitor;
 ...
 * its own state machine. Because each LogProcessor corresponds to a different functional module, such as Cap's naming
...
public class JRaftServer {
    ...
    synchronized void createMultiRaftGroup(Collection<RequestProcessor4CP> processors) {
        ...
        for (RequestProcessor4CP processor : processors) {
            ...
            CapStateMachine machine = new CapStateMachine(this, processor);
...
//            MetricsMonitor.raftReadFromLeader();
    ...
    public void applyOperation(Node node, Message data, FailoverClosure closure) {
        ...
        task.setDone(new CapClosure(data, status -> {
            CapClosure.NacosStatus nacosStatus = (CapClosure.NacosStatus) status;
    ...
    void refreshRouteTable(String group) {
        ...
        try {
            ...
            // fix issue #3661  https://github.com/alibaba/cap/issues/3661
...
//    }
    ...
    public static class RaftGroupTuple {
        ...
        private CapStateMachine machine;
