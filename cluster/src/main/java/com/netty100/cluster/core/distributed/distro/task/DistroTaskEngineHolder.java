...
package com.netty100.cluster.core.distributed.distro.task;
...
import com.netty100.cluster.core.distributed.distro.task.delay.DistroDelayTaskExecuteEngine;
import com.netty100.cluster.core.distributed.distro.task.delay.DistroDelayTaskProcessor;
...
public class DistroTaskEngineHolder implements DisposableBean {
    ...
    public void registerNacosTaskProcessor(Object key, CapTaskProcessor capTaskProcessor) {
        this.delayTaskExecuteEngine.addProcessor(key, capTaskProcessor);
    }
