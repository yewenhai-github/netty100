...
import com.netty100.cluster.core.cluster.MemberLookup;
...
public final class LookupFactory {
    ...
    private static final String LOOKUP_MODE_TYPE = "cap.core.member.lookup.type";
     ...
     */
    public static MemberLookup createLookUp(ServerMemberManager memberManager) throws CapException {
     ...
     * @param memberManager {@link ServerMemberManager}
     * @return {@link MemberLookup}
     * @throws CapException {@link CapException}
     */
    public static MemberLookup switchLookup(String name, ServerMemberManager memberManager) throws CapException {
...
//        }
    ...
    public static void destroy() throws CapException {
