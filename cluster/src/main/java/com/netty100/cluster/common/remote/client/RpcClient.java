...
import com.netty100.cluster.api.ability.ClientAbilities;
...
import com.netty100.cluster.api.remote.request.ClientDetectionRequest;
import com.netty100.cluster.api.remote.request.ConnectResetRequest;
import com.netty100.cluster.api.remote.request.HealthCheckRequest;
import com.netty100.cluster.api.remote.request.Request;
import com.netty100.cluster.api.remote.response.ClientDetectionResponse;
import com.netty100.cluster.api.remote.response.ConnectResetResponse;
import com.netty100.cluster.api.remote.response.ErrorResponse;
import com.netty100.cluster.api.remote.response.Response;
import com.netty100.cluster.common.lifecycle.Closeable;
import com.netty100.cluster.common.packagescan.resource.DefaultResourceLoader;
import com.netty100.cluster.common.packagescan.resource.ResourceLoader;
import com.netty100.cluster.common.remote.ConnectionType;
import com.netty100.cluster.common.remote.PayloadRegistry;
import com.netty100.cluster.common.utils.*;
...
public abstract class RpcClient implements Closeable {
     ...
     * Start this client.
     */
    public final void start() throws CapException {
        ...
        clientEventExecutor = new ScheduledThreadPoolExecutor(2, r -> {
            ...
            t.setName("com.netty100.cluster.client.remote.worker");
            t.setDaemon(true);
            return t;
        });
    ...
    /**
     * increase offset of the cap server port for the rpc server port.
     *
     ...
     */
    public Response request(Request request) throws CapException {
    ...
    public Response request(Request request, long timeoutMills) throws CapException {
        ...
        while (retryTimes < rpcClientConfig.retryTimes() && (timeoutMills <= 0 || System.currentTimeMillis() < timeoutMills + start)) {
            ...
            try {
                if (this.currentConnection == null || !isRunning()) {
                    waitReconnect = true;
                    throw new CapException(CapException.CLIENT_DISCONNECT,
                            "Client not connected, current status:" + rpcClientStatus.get());
                }
                response = this.currentConnection.request(request, timeoutMills);
                if (response == null) {
                    throw new CapException(CapException.SERVER_ERROR, "Unknown Exception.");
                }
                if (response instanceof ErrorResponse) {
                    if (response.getErrorCode() == CapException.UN_REGISTER) {
                        synchronized (this) {
                            waitReconnect = true;
                    ...
                    throw new CapException(response.getErrorCode(), response.getMessage());
                }
                // return response.
                lastActiveTimeStamp = System.currentTimeMillis();
                return response;
        ...
        if (exceptionThrow != null) {
            throw (exceptionThrow instanceof CapException) ? (CapException) exceptionThrow
                    : new CapException(CapException.SERVER_ERROR, exceptionThrow);
        } else {
            throw new CapException(CapException.SERVER_ERROR, "Request fail, unknown Error");
        }
    }
     ...
     * @param request request.
     */
    public void asyncRequest(Request request, RequestCallBack callback) throws CapException {
        int retryTimes = 0;
        ...
        while (retryTimes < rpcClientConfig.retryTimes()
            ...
            try {
                if (this.currentConnection == null || !isRunning()) {
                    waitReconnect = true;
                    throw new CapException(CapException.CLIENT_INVALID_PARAM, "Client not connected.");
                }
        ...
        if (exceptionToThrow != null) {
            throw (exceptionToThrow instanceof CapException) ? (CapException) exceptionToThrow
                    : new CapException(CapException.SERVER_ERROR, exceptionToThrow);
        } else {
            throw new CapException(CapException.SERVER_ERROR, "AsyncRequest fail, unknown error");
        }
    }
    ...
    public RequestFuture requestFuture(Request request) throws CapException {
        ...
        if (exceptionToThrow != null) {
            ...
            throw new CapException(CapException.SERVER_ERROR, "Request future fail, unknown error");
        }
    ...
    private ServerInfo resolveServerInfo(String serverAddress) {
        ...
        int defaultPort = Integer.parseInt(System.getProperty("com.netty100.kernel.tcp.port", "8981"));
