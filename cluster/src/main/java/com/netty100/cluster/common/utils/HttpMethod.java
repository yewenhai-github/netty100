...
public class HttpMethod {
    ...
    /**
     * this is only use in cap, Custom request type, essentially a GET request, Mainly used for GET request parameters
    ...
    /**
     * this is only use in cap, Custom request type, essentially a DELETE request, Mainly used for DELETE request
