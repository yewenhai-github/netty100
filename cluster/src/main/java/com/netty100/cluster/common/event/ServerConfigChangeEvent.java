...
package com.netty100.cluster.common.event;
 ...
 *
 * <p>
 * When cap server configuration file (default cap/conf/application.properties) changed, The event should be notify
 * to all subscriber.
 * </p>
 *
 * @author why
