...
package com.netty100.cluster.common.notify;
...
import com.netty100.cluster.common.utils.MapUtil;
...
public class NotifyCenter {
    ...
    static {
        ...
        String ringBufferSizeProperty = "cap.core.notify.ring-buffer-size";
        ringBufferSize = Integer.getInteger(ringBufferSizeProperty, 16384);
        
        // The size of the public publisher's message staging queue buffer
        String shareBufferSizeProperty = "cap.core.notify.share-buffer-size";
        shareBufferSize = Integer.getInteger(shareBufferSizeProperty, 1024);
        
        final Collection<EventPublisher> publishers = CapServiceLoader.load(EventPublisher.class);
        ...
        DEFAULT_PUBLISHER_FACTORY = (cls, buffer) -> {
            try {
                ...
                throw new CapRuntimeException(CapException.SERVER_ERROR, ex);
            }
        };
