...
import com.netty100.cluster.common.http.client.request.AsyncHttpClientRequest;
 ...
 */
public class CapAsyncRestTemplate extends AbstractNacosRestTemplate {
    
    private final AsyncHttpClientRequest clientRequest;
    
    public CapAsyncRestTemplate(Logger logger, AsyncHttpClientRequest clientRequest) {
        super(logger);
     ...
     * @param callback     callback {@link Callback#onReceive(RestResult)}
     */
