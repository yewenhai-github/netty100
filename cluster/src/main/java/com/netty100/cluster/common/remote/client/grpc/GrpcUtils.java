...
import com.netty100.cluster.api.grpc.auto.Metadata;
...
import com.netty100.cluster.api.utils.NetUtils;
import com.netty100.cluster.common.remote.exception.RemoteException;
...
public class GrpcUtils {
    ...
    public static Object parse(Payload payload) {
        ...
        if (classType != null) {
            ...
            throw new RemoteException(CapException.SERVER_ERROR,
