...
import com.netty100.cluster.common.http.client.request.DefaultAsyncHttpClientRequest;
import com.netty100.cluster.common.http.client.request.JdkHttpClientRequest;
import com.netty100.cluster.common.tls.TlsFileWatcher;
import com.netty100.cluster.common.tls.TlsHelper;
import com.netty100.cluster.common.tls.SelfHostnameVerifier;
import com.netty100.cluster.common.tls.TlsSystemConfig;
...
public abstract class AbstractHttpClientFactory implements HttpClientFactory {
    ...
    private static final String ASYNC_THREAD_NAME = "cap-http-async-client";
    
    private static final String ASYNC_IO_REACTOR_NAME = ASYNC_THREAD_NAME + "#I/O Reactor";
    
    @Override
    public CapRestTemplate createNacosRestTemplate() {
        ...
        return new CapRestTemplate(assignLogger(), clientRequest);
    }
    
    @Override
    public CapAsyncRestTemplate createNacosAsyncRestTemplate() {
        ...
        return new CapAsyncRestTemplate(assignLogger(), new DefaultAsyncHttpClientRequest(
