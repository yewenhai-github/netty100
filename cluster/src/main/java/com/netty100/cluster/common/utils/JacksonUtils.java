...
import com.netty100.cluster.api.exception.runtime.CapDeserializationException;
import com.netty100.cluster.api.exception.runtime.CapSerializationException;
...
public final class JacksonUtils {
     ...
     * @param obj obj
     * @return json string
     * @throws CapSerializationException if transfer failed
     */
    public static String toJson(Object obj) {
        try {
            return mapper.writeValueAsString(obj);
        } catch (JsonProcessingException e) {
            throw new CapSerializationException(obj.getClass(), e);
        }
    }
     ...
     * @return object
     * @throws CapDeserializationException if deserialize failed
     */
    public static <T> T toObj(byte[] json, Class<T> cls) {
        try {
            return mapper.readValue(json, cls);
        } catch (Exception e) {
            throw new CapDeserializationException(cls, e);
        }
    }
    ...
    public static <T> T toObj(byte[] json, Type cls) {
        try {
            ...
            throw new CapDeserializationException(e);
        }
    }
    ...
    public static <T> T toObj(String json, TypeReference<T> typeReference) {
        try {
            ...
            throw new CapDeserializationException(typeReference.getClass(), e);
        }
    }
    ...
    public static <T> T toObj(InputStream inputStream, Type type) {
        try {
            ...
            throw new CapDeserializationException(type, e);
        }
    }
