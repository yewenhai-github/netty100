...
package com.netty100.cluster.common.http.client;

import com.netty100.cluster.common.http.client.handler.ResponseHandler;
import com.netty100.cluster.common.http.client.request.DefaultHttpClientRequest;
import com.netty100.cluster.common.http.client.request.HttpClientRequest;
...
import com.netty100.cluster.common.model.RequestHttpEntity;
import com.netty100.cluster.common.utils.CollectionUtils;
import com.netty100.cluster.common.utils.HttpMethod;
import com.netty100.cluster.common.http.HttpClientConfig;
...
import com.netty100.cluster.common.http.param.MediaType;
 ...
 */
public class CapRestTemplate extends AbstractNacosRestTemplate {
    
    private final HttpClientRequest requestClient;
    
    private final List<HttpClientRequestInterceptor> interceptors = new ArrayList<>();
    
    public CapRestTemplate(Logger logger, HttpClientRequest requestClient) {
        super(logger);
