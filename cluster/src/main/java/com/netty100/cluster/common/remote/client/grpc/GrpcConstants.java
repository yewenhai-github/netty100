...
public class GrpcConstants {
    ...
    public static final String NACOS_SERVER_GRPC_PORT_OFFSET_KEY = "cap.server.grpc.port.offset";
    
    public static final String NACOS_CLIENT_GRPC = "cap.remote.client.grpc";
