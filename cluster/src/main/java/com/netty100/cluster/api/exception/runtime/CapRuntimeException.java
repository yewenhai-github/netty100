...
public class CapRuntimeException extends RuntimeException {
    ...
    public CapRuntimeException(int errCode) {
        super();
        this.errCode = errCode;
    }
    
    public CapRuntimeException(int errCode, String errMsg) {
        super(String.format(ERROR_MESSAGE_FORMAT, errCode, errMsg));
        this.errCode = errCode;
    }
    
    public CapRuntimeException(int errCode, Throwable throwable) {
        super(throwable);
        this.errCode = errCode;
    }
    
    public CapRuntimeException(int errCode, String errMsg, Throwable throwable) {
