...
package com.netty100.cluster.api.exception;
...
public class CapException extends Exception {
    ...
    public CapException(final int errCode, final String errMsg) {
        super(errMsg);
        this.errCode = errCode;
        this.errMsg = errMsg;
    }
    
    public CapException(final int errCode, final Throwable throwable) {
        super(throwable);
        this.errCode = errCode;
        this.setCauseThrowable(throwable);
    }
    
    public CapException(final int errCode, final String errMsg, final Throwable throwable) {
    ...
    public String getErrMsg() {
        if (SysUtility.isNotEmpty(this.errMsg)) {
            return this.errMsg;
        }
    ...
    /**
     * http client error code, ome exceptions that occurred when the use the Cap RestTemplate and Cap
     * AsyncRestTemplate.
     */
