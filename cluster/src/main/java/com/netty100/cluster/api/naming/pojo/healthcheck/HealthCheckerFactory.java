...
package com.netty100.cluster.api.naming.pojo.healthcheck;
...
public class HealthCheckerFactory {
    ...
    /**
     * Create default {@link AbstractHealthChecker.None} health checker.
     *
    ...
    public static AbstractHealthChecker deserialize(String jsonString) {
        try {
            ...
            throw new CapDeserializationException(AbstractHealthChecker.class, e);
        }
    }
    ...
    public static String serialize(AbstractHealthChecker healthChecker) {
        try {
            ...
            throw new CapSerializationException(healthChecker.getClass(), e);
        }
    }
}
