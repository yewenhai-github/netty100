...
package com.netty100.cluster.api.naming.utils;
...
public class NamingUtils {
    ...
    private static final Pattern CLUSTER_NAME_PATTERN = Pattern.compile(Constants.CLUSTER_NAME_PATTERN_STRING);
    
    private static final Pattern NUMBER_PATTERN = Pattern.compile(Constants.NUMBER_PATTERN_STRING);
     ...
     * @throws CapException if check failed, throw exception
     */
    public static void checkInstanceIsLegal(Instance instance) throws CapException {
     ...
     */
    public static void checkInstanceIsEphemeral(Instance instance) throws CapException {
     ...
     * @throws CapException Cap
     */
    public static void batchCheckInstanceIsLegal(List<Instance> instances) throws CapException {
