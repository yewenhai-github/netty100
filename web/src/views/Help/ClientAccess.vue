        ...
        <div class="fontend_container">
            <div class="view">
                ...
                <div class="view-detail">
                    ...
                    <div class="detail-item">
                        <h2 id="nettyNodeObtain">netty节点连接地址获取</h2>
                        <ul>
                            <li>
                    ...
                    <div class="detail-item">
                        <h2 id="msgList">获取系统支持的消息协议列表</h2>
                        <ul>
                            <li>
                                ...
                                <div class="li-detail">
                                    <table>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td align="center">protocolCode</td>
                                                <td align="center">消息协议代码</td>
                                                <td align="center">string</td>
                                            </tr>
                                            <tr>
                                                <td align="center">protocolDesc</td>
                                                <td align="center">描述信息</td>
                                                <td align="center">string</td>
                                            </tr>
                                            <tr>
                                                <td align="center">protocolName</td>
                                                <td align="center">消息协议名称</td>
                                                <td align="center">string</td>
                                            </tr>
                                            <tr>
                                                <td align="center">protocolType</td>
    ...
    export default defineComponent ({
        ...
        setup() {
            const state = reactive({
                navList: [
                    {name: "引入依赖", id: "relyOn"},
                    {name: "netty节点连接地址获取", id: "nettyNodeObtain"},
                    {name: "获取系统支持的消息协议列表", id: "msgList"},
