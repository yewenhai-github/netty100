...
public class WhyKernelProperties {
    ...
    public String getDomain() {
        return EnvUtil.getProperty(AddressServerMemberLookup.TOPE_NAME_SERVER_DOMAIN_PROPERTY, String.class, AddressServerMemberLookup.DEFAULT_SERVER_DOMAIN);
    }
    public String getToken() {
        return EnvUtil.getProperty(AddressServerMemberLookup.TOPE_NAME_SERVER_TOKEN_PROPERTY, String.class, "");
    }
